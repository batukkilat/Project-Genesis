...
| `genesis-render` | Phase 6 extraction core (read-only): snapshot → `RenderFrame` (sprites / bonds / cell aggregates by zoom tier), RON visual mappings, heatmap rasterizer (palettes, Bayer dither). Bevy arrives with the app shell. |
