...
| `genesis-persist` | Versioned binary save/load with integrity hash (format v13: physics params, LOD policy, env fields + dynamics, pending actions incl. impacts, rules, bonds, dynamic population); timeline branch records (RON sidecar ancestry, above the engine). |
